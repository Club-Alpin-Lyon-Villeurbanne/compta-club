...
export default function Home() {
  const ndfs = [
    ...
    {
      id: 103,
      titre: "les échelles de château richard et la croix du signal",
      commission: 19,
    ...
    {
      id: 104,
      titre: "4 jours de Vanoise sauvage en altitude",
      commission: 15,
      date: "12 Février 2023",
      statut: "Refusée"
    },
    {
      id: 106,
      titre: "Traversée Beaufortain Vanoise",
      commission: 20,
      date: "25 Mars 2023",
      statut: "En attente"
    },
    {
      id: 105,
      titre: "CYCLE SNOWBOARD VERS INITIÉ #4",
      commission: 32,
      date: "8 Avril 2023",
      statut: "En attente"
    },
                    ...
                    <tr key={ndf.id}>
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-3">
                            <p className="text-gray-900 whitespace-no-wrap">
                              <Link href={`/note-de-frais/${ndf.id}`}>{ndf.titre}</Link>
                            </p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <span
                          ...
                          <span className="relative">{ndf.statut}</span>
                        </span>
                      </td>
                    </tr>
                  ))}
